...
---
The solution will also work for the Let's play harder challenge.
When you connect to the server it will explain the rules.
You get 3 seconds to write where the requested shape is. There are 4 possible shapes: circle, rectangle, triangle and hexagon. There will be 200 of these tasks.
